## Shan's GitHub Portfolio

Hi, I'm Shan! Welcome to my GitHub portfolio. I'm a data scientist, with a Master's degree in Data Science and a Postgraduate diploma in Applied AI. I came to data science from a career in teaching, and what led me from one to the other was curiosity: I like taking a messy real-world problem apart until it makes sense, then building something to solve it. My main interests in the vast AI world are machine learning and computer vision. Here are some projects I have done for you to explore, enjoy!
...
- **RL for Belgian Apartment Heating** (https://github.com/Suzyxx/rl-belgian-heating)
  ...
  A reinforcement learning agent that controls electric heating using real hourly electricity prices and grid carbon data, cutting cost and emissions compared to a standard thermostat while keeping the room comfortable.

- **MLOps pipeline on AWS** (https://github.com/Suzyxx/mlops-terraform)
  
  End-to-end infrastructure as code with Terraform: containerised model, CI/CD, ECR, and MLflow experiment tracking and registry.
